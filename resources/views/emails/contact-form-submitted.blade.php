...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <p style="font-size: 16px; margin-bottom: 25px;">You have received a new contact form submission with the
                following details:</p>
            ...
            <div class="info-row">
                ...
                <div class="info-value">{{ $contact->source_page ?? 'N/A' }}</div>
            </div>
        ...
        <div class="email-footer">
            <p style="margin: 0;">This email was sent from your BingeAt Media website contact form.</p>
